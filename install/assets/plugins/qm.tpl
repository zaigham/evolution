...
if (isset($_SESSION['mgrValidated'])) {
    ...
    if ($show) {
        ...
        if (isset($_SESSION['mgrValidated'])) {
            ...
            $qm = new Qm($modx, $loadmanagerjq, $modx->config['jquery_noconflict'], $loadtb, $tbwidth, $tbheight, $hidefields, $hidetabs, $hidesections, $addbutton, $custombutton, $managerbutton, $logout, $autohide, $editbuttons, $editbclass, $newbuttons, $newbclass, $tvbuttons, $tvbclass);
        }
    }
}
