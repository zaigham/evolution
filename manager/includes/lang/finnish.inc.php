...
$_lang["charset_message"] = 'Valitse käytettävä merkistö [(modx_charset)] asetukselle.';
...
$_lang["search_results_returned_msg"] = 'Haulla löytyi <strong>%s</strong> sivua. Jos hakutuloksia on paljon, yritä käyttää tarkempia hakuehtoja.';
