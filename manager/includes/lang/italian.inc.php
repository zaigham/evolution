...
$_lang["access_permissions_links_tab"] = 'Qui potete specificare a quali Gruppi di Utenti è permesso l\'accesso ai Gruppi di Risorse (ad es.: possono modificare o creare Risorse). Per collegare un Gruppo di Risorse a un Gruppo di Utenti, selezionatelo dalla lista a tendina e fate clic su \'Aggiungi gruppo\'. Per rimuovere il collegamento ad un certo gruppo premete \'Rimuovi ->\'. Il collegamento sarà eliminato immediatamente.';
...
$_lang["allow_mgr_access_message"] = 'Selezionate questa opzione per abilitare o disabilitare l\'accesso alla interfaccia di amministrazione. <b>NOTA: Se questa opzione è attiva, gli utenti verranno ridiretti alla Interfaccia di amministrazione o alla pagina di inizio del sito.</b>';
...
$_lang["blocked_minutes_message"] = 'Qui potete inserire per quanti minuti un utente sarà bloccato dopo aver superato il limite consentito di login errati. Inserire solo il numero, senza punti o virgole.';
...
$_lang["captcha_message"] = 'Abilitatelo per aumentare la sicurezza richiedendo agli utenti di inserire un codice illeggibile dalle macchine (e dagli script scriptkiddy degli hackers).';
...
$_lang["cfg_base_path"] = 'Base path';
$_lang["cfg_base_url"] = 'Base URL';
$_lang["cfg_manager_path"] = 'Manager path';
$_lang["cfg_manager_url"] = 'Manager URL';
$_lang["cfg_site_url"] = 'Site URL';
$_lang["change_name"] = 'Cambia nome';
$_lang["change_password"] = 'Cambia password';
$_lang["change_password_confirm"] = 'Conferma password';
$_lang["change_password_message"] = 'Inserite la nuova password e successivamente riscrivetela per conferma. La password deve essere lunga fra 6 e 15 caratteri.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' non può scrivere nella cartella cache. '.CMS_NAME.' continuerà a funzionare come previsto, ma non effettuerà alcuna operazione di caching. Per risolvere, rendete la cartella /_cache/ scrivibile.';
$_lang["configcheck_configinc"] = 'Il file di configurazione (/manager/includes/config.inc.php) è ancora scrivibile';
$_lang["configcheck_configinc_msg"] = 'Malintenzionati potrebbero combinare guai sul vostro sito e tutto ciò che è collegato ad esso. <strong>Sul serio.</strong> Impostate il file di configurazione (/manager/includes/config.inc.php) in sola lettura!';
...
$_lang["configcheck_errorpage_unpublished"] = 'La pagina di Errore del vostro sito non è stata pubblicata oppure è inesistente.';
$_lang["configcheck_errorpage_unpublished_msg"] = 'Ciò significa che la pagina di Errore è inaccessibile da parte del pubblico. Pubblicate la pagina o selezionate una Risorsa esistente nella struttura ad albero del vostro sito dal menu Strumenti -> Configurazione.';
...
$_lang["configcheck_installer_msg"] = 'La cartella install/ contiene l\'installer di '.CMS_NAME.'. Immaginate cosa potrebbe accadere se un malintenzionato trovasse questa cartella ed eseguisse l\'installer! Probabilmente non andrebbe troppo lontano perchè dovrebbe fornire alcune informazioni utente per il database, ma è sempre meglio rimuovere questa cartella dal server.';
...
$_lang["configcheck_notok"] = 'Uno o più dettagli della configurazione devono essere verificati: ';
...
$_lang["configcheck_templateswitcher_present_msg"] = 'Il plugin TemplateSwitcher può creare problemi di prestazioni e caching, vi consigliamo di utilizzarlo solo se necessario.';
$_lang["configcheck_title"] = 'Controllo configurazione';
$_lang["configcheck_unauthorizedpage_unavailable"] = 'La pagina Non Autorizzato del vostro sito non è stata pubblicata o non esiste';
...
$_lang['configcheck_error_handling_silent'] = 'Gli errori del Parser verranno mostrati agli utenti';
$_lang['configcheck_error_handling_silent_msg'] = 'L\'impostazione <strong>Mostrare gli errori PHP/SQL agli utenti</strong> consente la visualizzazione degli errori. Questa impostazione è consigliata in fase di sviluppo ma non dovrebbe essere utilizzata su siti in produzione.';
...
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' è gestito e mantenuto su <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMS.com</a>.</p>';
...
$_lang["database_overhead"] = '<b style=\'color:#990033\'>Note:</b> L\'Overhead è lo spazio inutilizzato riservato da MySQL. Per liberare questo spazio, cliccate sulla cifra overhead della tabella.';
...
$_lang["deleting_file"] = 'Eliminazione del file `%s`: ';
...
$_lang["duplicate_alias_message"] = 'Qui potete impostare \'si\' per permettere gli alias duplicati. <b>NOTA: Questa opzione deve essere usata con l\'opzione \'Percorso URL semplici\' attivata per evitare problemi di riferimenti alle Risorse.</b>';
...
$_lang["editor_css_path_message"] = 'Inserite il percorso del file CSS che volete usare con l\'editor. Il miglior metodo è inserire il percorso dalla root del vostro server, ad esempio: /assets/site/style.css. Se non volete caricare lo stile nell\'editor, lasciate vuoto questo campo.';
...
$_lang["filemanager_path_message"] = 'IIS spesso non riesce a determinare correttamente la cartella principale usata dal File Manager per stabilire ciò che potete vedere. Se avete problemi nell\'uso del File Manager, assicuratevi che il percorso punti alla root dell\'installazione di '.CMS_NAME.'.';
...
$_lang["forgot_password_email_intro"] = 'E\' stata fatta una richiesta di variazione della password del vostro account.';
...
$_lang["friendlyurlsuffix_message"] = 'Qui potete specificare il suffisso delle URL semplici. Specificando \'.html\' sarà aggiunto .html a tutti gli URL semplici.';
...
$_lang["htmlsnippet_msg"] = 'Qui potete aggiungere/modificare i chunk. Ricordate, i chunk sono codice HTML \'raw\' (grezzo), quindi qualsiasi codice PHP non verrà processato.';
...
$_lang["login_allowed_ip_message"] = 'Inserite l\'indirizzo IP autorizzato all\'accesso. <b>NB: Separate differenti indirizzi IP con una virgola (,)</b>';
$_lang["login_button"] = 'Accedi';
$_lang["login_cancelled_install_in_progress"] = '<span style="font-weight: bold; color: red;">E\' in corso l\'installazione o l\'aggiornamento di questo. <br />Riprovare tra qualche minuto</span><br />';
$_lang["login_cancelled_site_was_updated"] = '<span style="font-weight: bold; color: red;">L\'installazione o l\'aggiornamento del sito sono terminati, effettuare nuovamente il login!</span><br />';
...
$_lang["mgrlog_query_msg"] = 'Per vedere i log, fate una selezione. Potete selezionare un intervallo di date, ma ricordate che le date che immettete non sono entrambe incluse. Ad esempio per selezionare tutti i dati di log del giorno 1 gennaio 2007, impostate \'Data iniziale\' su 01-01-2007 e \'Data finale\' su 02-01-2007.<br /><br />Messaggio ed azione sono in genere coincidenti. Se state cercando un messaggio specifico, è meglio impostare l\'azione su \'Qualunque/tutti\'.';
...
$_lang["modx_news"] ='Ultime notizie su '.CMS_NAME;
$_lang["modx_news_tab"] ='Novità '.CMS_NAME;
$_lang["modx_news_title"] ='Novità '.CMS_NAME;
...
$_lang["move_resource_message"] = 'Potete spostare una Risorsa e tutti i suoi sottodocumenti selezionando un nuovo genitore nella struttura ad albero. Se selezionate una Risorsa che non è una cartella verrà trasformata in cartella. Cliccate sulla nuova Risorsa genitore nella struttura ad albero delle Risorse.';
...
$_lang["page_data_publishdate_help"] = 'Se impostate una data di pubblicazione, la Risorsa sarà pubblicata alla data prescelta. Cliccate sull\'icona del calendario per selezionare una data di pubblicazione o sull\'icona a fianco per rimuoverla. Con questo sistema, la Risorsa non verrà mai pubblicata automaticamente.';
...
$_lang["page_data_unpublishdate_help"] = 'Se impostate una data di ritiro, la Risorsa sarà ritirata alla data prescelta. Cliccate sull\'icona del calendario per selezionare una data di ritiro o sull\'icona a fianco per rimuoverla. Con questo sistema, la Risorsa non verrà mai ritirato automaticamente.';
...
$_lang["password_change_request"] = 'Richiesta di modifica della password';
$_lang["password_gen_gen"] = 'Lasciate che sia '.CMS_NAME.' a generare la password.';
...
$_lang["php_version_check"] = CMS_NAME.' è compatibile con PHP versione 4.0.3 o superiore. Si prega di aggiornare l\'installazione di PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["rb_base_dir_message"] = 'Inserite il percorso fisico alla directory delle Risorse. Questa impostazione è generata automaticamente. Se state usando IIS, tuttavia, '.CMS_NAME.' potrebbe non riuscire ad impostare il percorso corretto, inducendo il browser delle Risorse a mostrare un errore. In quel caso, qui potete correggere il percorso alla cartella delle immagini  (il percorso che vedete in Windows Explorer). <b>NOTA:</b> La directory delle Risorse deve contenere le sottocartelle images, files, flash e media affinchè funzioni correttamente con il Browser di Risorse.';
$_lang["rb_base_dir_title"] = 'Percorso delle Risorse:';
$_lang["rb_base_url_message"] = 'Inserite il percorso virtuale alla directory delle Risorse. Questa impostazione è generata automaticamente. Se state usando IIS, tuttavia, '.CMS_NAME.' potrebbe non riuscire ad impostare il percorso corretto, inducendo il browser delle Risorse a mostrare un errore. In quel caso, qui potete correggere il percorso alla cartella delle immagini  (l\'URL che vedete in Internet Explorer).';
...
$_lang["refresh_cache"] = 'Cache: Sono stati trovati <b>%s</b> file nella cartella cache e sono stati eliminati <b>%d</b> file di cache.<p>I nuovi file di cache saranno creati man mano che le pagine saranno richieste.';
...
$_lang["resource_alias_help"] = 'Qui potete inserire un alias per la Risorsa. Questo renderà la Risorsa accessibile come http://vostroserver/alias. Funziona solo se state usando gli URL semplici.';
...
$_lang["resource_opt_contentdispo_help"] = 'Utilizzate il campo pubblicazione contenuto per impostare come il browser avrà accesso al contenuto della Risorsa. Per file da scaricare selezionare come opzione Allegato.';
$_lang["resource_opt_emptycache"] = 'Svuota cache?';
$_lang["resource_opt_emptycache_help"] = 'Lasciando questo campo selezionato permetterete a '.CMS_NAME.' di svuotare la cache dopo che avrete salvato la Risorsa. Così i visitatori non vedranno più la vecchia versione della Risorsa.';
...
$_lang["resource_type_message"] = 'Un Link Web è un collegamento ad una Risorsa su Internet. Questa Risorsa può essere interna a '.CMS_NAME.', una pagina su un altro sito, un\'immagine o un altro file su Internet. I Link Web dovrebbero avere Media Type text/html e Inline Content-Disposition.';
...
$_lang["rss_url_news_message"] = 'Inserire l\'URL per il Feed Novità '.CMS_NAME.'.';
...
$_lang["search_results_returned_msg"] = 'I criteri di ricerca hanno restituito <b>%s</b> Risorse. Se i risultati sono molti, provate con una ricerca più specifica. Le due colonne più a sinistra permettono di trovare la Risorsa nella struttura ad albero o di visualizzarla. Le due colonne più a destra mostrano, rispettivamente, se una Risorsa è stata eliminata e qual\'è il suo stato di pubblicazione.<p />';
...
$_lang["settings_after_install"] = 'Dato che questa è una nuova installazione, vi preghiamo di controllare queste impostazioni e di cambiare quelle che desiderate. Dopo aver controllato le impostazioni, premete \'Salva\' per aggiornarne la configurazione di sistema.<br /><br />';
...
$_lang["settings_strip_image_paths_message"] = 'Se questo valore è impostato su \'No\', '.CMS_NAME.' imposterà il percorso del browser dei file (immagini, file, flash, ecc.) su relativo invece che su assoluto. Questa opzione risulta utile se dovete spostare l\'installazione di '.CMS_NAME.' (ad esempio da un sito di test ad uno di produzione). Se non avete idea di cosa significa, lasciala impostata su \'si\'.';
...
$_lang["template_msg"] = 'Qui potete creare/modificare i template. I template modificati o nuovi non saranno visibili nelle pagine in cache finchè la cache stessa non verrà svuotata. Ad ogni modo, potete usare la funzione di anteprima su una pagina per vedere il template in azione.';
...
$_lang["tree_show_protected_message"] = 'Se impostato "No", Le pagine protette (e tutte le pagine figlie) non appariranno nell\'albero delle Risorse. "No" è l\'impostazione di default di '.CMS_NAME.'.';
...
$_lang["use_alias_path_message"] = 'Impostando questa opzione su \'si\' verrà mostrato il percorso completo alla Risorsa, se la Risorsa ha un alias. Ad esempio, se una Risorsa con un alias \'figlio\' si trova nella cartella con alias \'genitore\', il percorso dell\'alias sarà \'/genitore/figlio.html\'.<br /><b>NOTA: Impostando questa opzione su \'si\' (attivando il percorso alias), dovete far riferimento a file (come immagini, css, javascript, etc) usando il percorso assoluto:  ad esempio, \'/assets/images\' anzichè \'assets/images\'. In questo modo impedirete al browser (o web server) di collegare il percorso relativo al percorso dell\'alias.</b>';
$_lang["use_alias_path_title"] = 'Usa i percorsi semplici dell\'alias:';
$_lang["use_editor_message"] = 'Volete abilitare l\'editor rich text? Se reputate più confortevole scrivere in HTML, con questa impostazione potete disabilitarlo. Da notare che le impostazioni si applicano a tutte le Risorse e a tutti gli utenti!';
...
$_lang["websignupemail_message"] = 'Qui potete impostare il messaggio da inviare agli utenti quando creerete loro un account e volete che '.CMS_NAME.' invii una e-mail contenente nome utente e password. <br />Nota:</b> I seguenti segnaposto saranno sostituiti dal sistema di gestione del contenuto quando invierà il messaggio: <br /><br />[+sname+] - Nome del sito, <br />[+saddr+] - Indirizzo email del sito, <br />[+surl+] - Url del sito, <br />[+uid+] - Login o id dell\'utente, <br />[+pwd+] - Password utente, <br />[+ufn+] - Nome completo dell\'utente. <br /><br /><b>Lasciate [+uid+] e [+pwd+] nella e-mail, altrimenti il nome utente e la password non verranno inviati!<</b>';
...
$_lang["xhtml_urls_message"] = 'Sostituisce la e commerciale (ampersand (&amp;)) negli indirizzi generati da  '.CMS_NAME.' con l\' entità HTML &<!-- -->amp;';
$_lang["xhtml_urls_title"] = 'URL XHTML';
$_lang["yes"] = 'Si';
$_lang["you_got_mail"] = 'Avete una nuova mail';
$_lang["yourinfo_message"] = 'Questa sezione mostra alcune informazioni su di voi:';
...
$_lang['error_handling_deprecated_label'] = 'Come devono essere gestite le funzioni PHP deprecate (PHP >= 5.3)';
$_lang['error_handling_deprecated_0'] = 'Consentire l\'utilizzo di funzioni PHP deprecate. Nessuna segnalazione di errore.';
$_lang['error_handling_deprecated_1'] = 'Consentire l\'utilizzo di funzioni PHP deprecate. Segnalazione su Resoconti, Eventi di Sistema';
$_lang['error_handling_deprecated_2'] = 'Non consentire l\'utilizzo di funzioni PHP deprecate. Mostra un errore e termina';
$_lang['error_handling_silent_label'] = 'Mostrare gli errori PHP/SQL agli utenti.';
$_lang['error_handling_silent_0'] = 'Mostrare gli errori a video';
$_lang['error_handling_silent_1'] = 'Non mostare gli errori. L\'esecuzione termina con una pagina bianca.';
$_lang['jquery_url_label'] = 'URL jQuery';
$_lang['jquery_plugin_dir'] = 'Directory plugin jQuery';
$_lang['jquery_noconflict'] = 'Utilizzare jQuery.noConflict()';
?>
