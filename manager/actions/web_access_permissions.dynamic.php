...
<div class="sectionBody">
	...
	<div id="web-access-permissions-tabs" class="js-tabs">
		<ul>
			<li><a href="#tabPermUserGroups"><?php echo $_lang['web_access_permissions_user_groups'] ?></a></li>
			<li><a href="#tabPermResGroups"><?php echo $_lang['access_permissions_resource_groups'] ?></a></li>
			<li><a href="#tabPermLinks"><?php echo $_lang['access_permissions_links'] ?></a></li>
		</ul>
		
		<div id="tabPermUserGroups">
		...
		</div><!-- tabPermUserGroups -->
		
		<div id="tabPermResGroups">
