...
$_lang['timezone_note'] = 'Setting the timezone explicitly in the config file makes porting sites across servers more reliable as it will override a server\'s php.ini value. It also avoids issues with PHP 5.4 if a timezone is not set in php.ini.';
