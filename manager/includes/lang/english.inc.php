...
$_lang["charset_message"] = 'Select the default character encoding for the [(modx_charset)] system variable.';
...
$_lang['configcheck_locale_LC_ALL_warning'] = 'Locale LC_ALL not set correctly';
$_lang['configcheck_locale_LC_ALL_warning_msg'] = 'LC_ALL as defined in config.inc.php is not detected as being the current locale for LC_ALL.';
$_lang['configcheck_locale_LC_NUMERIC_warning'] = 'Locale LC_NUMERIC not set correctly';
$_lang['configcheck_locale_LC_NUMERIC_warning_msg'] = 'LC_NUMERIC as defined in config.inc.php is not detected as being the current locale for LC_NUMERIC.';
...
$_lang['package_manager_upload_byurl_text'] = 'Upload a package by manually entering the URL';
$_lang['package_manager_upload_byfile_text'] = 'Manually upload a package file from your local machine';
$_lang['package_manager_upload_byfolder_text'] = 'Manually specify a package folder on this web server';
$_lang['package_manager_upload_byurl_label'] = 'Upload from URL';
$_lang['package_manager_upload_byfile_label'] = 'Upload from local machine';
$_lang['package_manager_upload_byfolder_label'] = 'Read package from folder';
...
$_lang['package_manager_autoinstall_html0'] = '<div><p><strong>Use the following plugin code for auto-installation during development.</strong> Attach to OnWebPageInit.</p><pre>';
...
$_lang["function_no_longer_impl"] = 'Sorry! Functionality removed.';
$_lang["function_no_longer_impl_message"] = 'This function is no longer implemented.';
$_lang["go"] = 'Go';
...
$_lang['rss_len_title'] = 'RSS feed length';
$_lang['rss_len_message'] = 'How many items should be in the site\'s own RSS feed?';
...
$_lang["search_results_returned_msg"] = 'Your search criteria returned <b>%s</b> Resources. If a lot of results are being returned, try to enter a more specific search. The two left-most columns will allow you to find the Resource in the Site Tree or view the Resource.';
...
$_lang["settings_after_install"] = 'As this is a new install, you are required to check these settings, and change any that you may wish to. After checking the settings, press \'Save\' to update the settings database.';
