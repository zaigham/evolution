...
class TinyMCE
{
	...
	{
		global $modx;
		$ph['cmsurl']  = MODX_BASE_URL . 'manager/media/browser/'.$modx->config['file_browser'].'/browser.php?Connector=';
		$ph['cmsurl'] .= MODX_BASE_URL . 'manager/media/browser/'.$modx->config['file_browser'].'/connectors/php/connector.php&ServerPath=';
