...
$_lang["search_results_returned_msg"] = 'Търсенето откри <b>%s</b> документа. В случай, че върнатите резултати са много, опитайте се да детайлизирате търсенето. Двете най-леви колони ви дават възможност да намерите документа в дървото или да го разгледате.';
