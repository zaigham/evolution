...
$_lang["checking_if_dirs_exist"] = 'Проверка дали съществува директорията [+dirs+] : ';
$_lang["checking_if_dirs_writable"] = 'Проверка дали в директорията [+dirs+] може да се пише: ';
