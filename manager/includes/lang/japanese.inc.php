...
// NEEDS EDITING $_lang["charset_message"] = '管理画面で使用したいエンコードを選択できます。すでにUTF-8で運用している場合、EUCを選択すると既存のコンテンツや設定などは文字化けします。事前にphpMyAdminなどを利用して変換し、設定変更後にインポートし直す必要があります。';
...
$_lang["search_results_returned_msg"] = '<strong>%s</strong>件のデータが見つかりました。多くの検索結果が表示される場合は、検索範囲を更に狭くしてください。左側二つのカラムでは、サイトツリーでリソースを探したり、リソースを表示したりすることができます。';
