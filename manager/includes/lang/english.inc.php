...
$_lang['package_manager_upload_byfolder_text'] = 'Manually specify a package folder on the web server';
...
$_lang['package_manager_upload_byfolder_label'] = 'Upload from this server';
